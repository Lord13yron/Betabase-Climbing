// Inline Lucide-style icons for the profile page. Swap 1:1 for `lucide-react`
// (`import { Pencil, Flag, … } from 'lucide-react'`) if you prefer the package —
// the names map directly. Stroke inherits `currentColor`; the CSS sets size.
...
export const CameraIcon = S(
  <>
    <path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z" />
    <circle cx="12" cy="13" r="3" />
  </>
)
export const XIcon = S(
  <>
    <path d="M18 6 6 18" />
    <path d="m6 6 12 12" />
  </>
)
export const ShareIcon = S(
  <>
