  ...
  return (
    <section className="bb-hero" id="top">
      ...
      <div className="bb-hero-inner">
        <div className="bb-eyebrow bb-eyebrow-line mb-[22px]">A climbing beta network</div>
        ...
        <p className="bb-hero-sub">
          Find your gym, watch how the locals climbed it, and send your project. Community beta for
          every wall, every grade.
        </p>
        <div className="flex gap-[14px]">
          <Link href="/gyms" className="bb-btn bb-btn-primary">
            <Icon name="search" size={18} color="var(--on-accent)" />
            Find your gym
          </Link>
          <Link href="/signup" className="bb-btn bb-btn-ghost-light">
      ...
      <div className="bb-hero-steps">
        <div className="bb-mono-label" style={{ color: "var(--color-plywood-400)" }}>
          The loop
        </div>
        <span>Watch</span>
        <span>Learn</span>
