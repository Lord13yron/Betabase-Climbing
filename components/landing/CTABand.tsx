...
export function CTABand() {
  return (
    <section className="bb-cta px-[56px] py-[120px] text-center" id="community">
      <div className="mx-auto max-w-[620px]">
        ...
        <div className="flex justify-center gap-[14px]">
          <Link href="/signup" className="bb-btn bb-btn-ink">
            <Icon name="user" size={18} color="var(--color-chalk-50)" />
            Sign up free
          </Link>
          <Link href="/gyms" className="bb-btn bb-btn-ghost-chalk">
